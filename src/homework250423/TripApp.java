...
public class TripApp {
    ...
    public static void main(String[] args) {
        ...
        trips.add(new Trip("Berlin", "München", 7, 250, LocalDate.of(2023, 5, 15), LocalDate.of(2023, 5, 23)));
        trips.add(new Trip("Berlin", "Kassel", 5, 150, LocalDate.of(2023, 8, 16), LocalDate.of(2023, 9, 13)));
        trips.add(new Trip("Berwang", "Hamburg", 10, 350, LocalDate.of(2023, 6, 15), LocalDate.of(2023, 6, 28)));
        trips.add(new Trip("Bonn", "Warburg", 4, 100, LocalDate.of(2023, 5, 5), LocalDate.of(2023, 6, 23)));
